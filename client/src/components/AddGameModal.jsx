        ...
        <div id="addGameContainer">
            ...
            <form method="POST" action="http://localhost:3001/videogame" name="formAddGame">
                <div className="divsFlex">
                    <div>
                <label key={1} className="subtitle" title="Required">Game name*:</label>                
                ...
                <label key={5} className="subtitle description" title="Required">Description*:</label><br/>
                ...
                <a style={{width:'95%', textAlign:'left'}}>Select one or more genres</a>
                ...
                <a style={{width:'95%', textAlign:'left'}}>Select one or more platforms</a>
                ...
                <div className="divsGrid">
                     <div>
                     <div id='divModalMostrarGeneros' style={{height:'50px', width: '80%', overflow:'auto', padding:'0px 10px', color:'var(--main-bg-color)', position:'relative'}}>{nombresGeneros.join(" | ")}</div>
                     </div>
                     <div>
                     <div id='divModalMostrarPlataformas' style={{height:'50px', width:'80%', overflow:'auto', padding:'0px 10px', color:'var(--main-bg-color)', position:'relative', left:'-80px'}}>{nombresPlataformas.join(" | ")}</div>    
                     </div>
                     </div> 
